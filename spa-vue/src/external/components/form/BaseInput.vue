<template>
  <div class="form-group"
    :class="{ error: error, md: size === 'md', lg: size === 'lg', disabled: disabled, 'icone-esquerdo-externo': $slots.iconeEsquerdoExterno, 'icone-direito-externo': $slots.iconeDireitoExterno }">
    <div class="grid">
      <div class="div1">
        <div class="div3">
          <template v-if="$slots.iconeEsquerdoExterno">
            <slot name="iconeEsquerdoExterno"></slot>
          </template>
        </div>
      ...
      <div class="div2">
        ...
        <div style="display: flex; align-items: center; flex: 1" class="form-all-container">
        ...
        <div class="div4">
          <template v-if="$slots.iconeDireitoExterno">
            <slot name="iconeDireitoExterno"></slot>
          </template>
        </div>
      </div>
      <div class="div5">
