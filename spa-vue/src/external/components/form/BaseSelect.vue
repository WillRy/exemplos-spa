    ...
    <div class="form-group" :class="{
        ...
        <div style="display: flex;">
            <div class="form-group-container" :class="{ borda: borda, btn: $slots.btn }">
                ...
                <VueMultiselect v-bind="attrs" :allow-empty="empty" :deselectLabel="remover ? 'Remover' : ''"
                    :label="textBy" :model-value="modelValue" :options="options" :searchable="search"
                    :track-by="trackBy" deselectGroupLabel="" selectGroupLabel="" selectLabel="" selectedLabel=""
                    @update:model-value="updateValue" :placeholder="placeholder"
                    :limitText="(count) => `e mais ${count}`" :disabled="disabled" :loading="loading">
