...
<script setup>
import { defineProps, reactive, onBeforeMount, watch, ref } from 'vue'
...
function gerarEscala(cor) {
  ...
  Object.assign(thema.value, novaEscala)
}
...
:root {
  ...
  --color-primary-principal: v-bind('thema.primaryColor[400]');
  --color-primary-principal-hover: v-bind('thema.primaryColor[300]');
  --color-primary-principal-active: v-bind('thema.primaryColor[700]');
  --color-primary-principal-focus: v-bind('thema.primaryColor[300]');
}
