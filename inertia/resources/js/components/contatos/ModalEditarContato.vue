<template>
  <BaseModal :aberta="contato" @onClose="fecharModal" @onOpen="carregarFormulario">
    ...
    <template #footerDireito>
      <BaseButtonTertiary @click.prevent="fecharModal"> Cancelar </BaseButtonTertiary>
      <BaseButtonPrimary @click.prevent="submit" :loading="loading"> Editar </BaseButtonPrimary>
    </template>
  </BaseModal>
</template>
