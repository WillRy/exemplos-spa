  ...
  <div class="sidebar" :class="{ open: open }">
    <div class="logo-details">
      ...
      <div class="btn-menu">
        ...
        />
        <img
          src="../../assets/arrow-left-w.svg"
          class="btn-menu white"
          alt=""
          @click="toggle"
          v-if="open"
        />
        <img
          src="../../assets/arrow-left-b.svg"
          class="btn-menu black"
          alt=""
          @click="toggle"
          v-if="open"
        />
    ...
    <ul class="nav-list">
      <li>
        <NuxtLink to="/painel/dashboard" :prefetch="false">
      ...
      <li>
        <NuxtLink to="/painel/organizacoes" :prefetch="false">
      ...
      <li>
        <NuxtLink to="/painel/contatos" :prefetch="false">
...
.sidebar li a.router-link-exact-active img.white {
  display: none;
}

.sidebar li a:hover img.black,
.sidebar li a.router-link-exact-active img.black {
  display: block;
}
